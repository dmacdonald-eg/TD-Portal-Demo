...
/* Tour step definitions + popover component. ~47 steps walking through every
   marquee feature of the Client Portal. */
...
export const STEPS = [
  ...
  // ── DASHBOARD ───────────────────────────────────────────────────────────
  {
    id: 'active-banner', view: 'dashboard', target: 'active-banner', placement: 'bottom',
  ...
  {
    id: 'alert-trends', view: 'dashboard', target: 'alert-trends', placement: 'top',
  ...
  {
    id: 'top-rules', view: 'dashboard', target: 'top-rules', placement: 'right',
  ...
  {
    id: 'data-sources', view: 'dashboard', target: 'data-sources', placement: 'left',
  ...
  {
    id: 'recent-incidents', view: 'dashboard', target: 'recent-incidents', placement: 'top',
  ...
  // ── INCIDENTS LIST ──────────────────────────────────────────────────────
  {
    id: 'go-incidents', view: 'dashboard', target: 'nav-incidents', placement: 'right',
    title: 'Drill into the full queue',
    body: 'Click "Incidents" in the sidebar to see all incidents with filters and sorting.',
    advance: 'click',
  },
  {
    id: 'incidents-filter', view: 'incidents-list', target: 'incidents-filter', placement: 'bottom',
  ...
  // ── INCIDENT DETAIL ─────────────────────────────────────────────────────
  {
    id: 'detail-header', view: 'incident-detail', target: 'detail-header', placement: 'bottom',
  ...
  {
    id: 'ai-summary', view: 'incident-detail', target: 'ai-summary', placement: 'left',
  ...
  {
    id: 'incident-chat', view: 'incident-detail', target: 'incident-chat', placement: 'top',
  ...
  {
    id: 'expand-alert', view: 'incident-detail', target: 'alert-card-expand', placement: 'bottom',
  ...
  {
    id: 'ticket-detail-summary', view: 'ticket-detail', target: 'ticket-summary', placement: 'right',
  ...
  // ── SENTINEL HEALTH ─────────────────────────────────────────────────────
  {
    id: 'go-health', view: 'ticket-detail', target: 'nav-health', placement: 'right',
    title: 'Sentinel platform health',
    body: 'Click "Sentinel Health" to monitor data ingestion, connector status, and rule execution.',
    advance: 'click',
  },
  {
    id: 'health-overview', view: 'health', target: 'health-overview', placement: 'bottom',
  ...
  // ── MAIL HYGIENE ────────────────────────────────────────────────────────
  {
    id: 'go-mail', view: 'health', target: 'nav-mail', placement: 'right',
    title: 'Mail hygiene from Defender for Office 365',
    body: 'Click "Mail Hygiene" in the sidebar.',
    advance: 'click',
  },
  {
    id: 'mail-kpis', view: 'mail', target: 'mail-kpis', placement: 'bottom',
  ...
  {
    id: 'mail-trend', view: 'mail', target: 'mail-trend', placement: 'top',
    title: 'Threat trend',
    body: 'Daily threat volume by severity — same stacked-area visualization as the incident trend.',
  },
  {
    id: 'mail-delivery', view: 'mail', target: 'mail-delivery', placement: 'right',
  ...
  // ── IDENTITY HYGIENE ────────────────────────────────────────────────────
  {
    id: 'go-identity', view: 'mail', target: 'nav-identity', placement: 'right',
    title: 'Identity attack surface',
    body: 'Click "Identity" in the sidebar.',
    advance: 'click',
  },
  {
    id: 'identity-kpis', view: 'identity', target: 'identity-kpis', placement: 'bottom',
  ...
  {
    id: 'risky-users', view: 'identity', target: 'risky-users', placement: 'top',
  ...
  {
    id: 'ca-policies', view: 'identity', target: 'ca-policies', placement: 'right',
  ...
  {
    id: 'mfa-coverage', view: 'identity', target: 'mfa-coverage', placement: 'left',
  ...
  {
    id: 'identity-geo', view: 'identity', target: 'identity-geo', placement: 'top',
  ...
  // ── THREAT INTEL ────────────────────────────────────────────────────────
  {
    id: 'go-threatintel', view: 'identity', target: 'nav-threatintel', placement: 'right',
  ...
  {
    id: 'threatintel-briefings', view: 'threat-intel', target: 'threatintel-briefings', placement: 'top',
  ...
  {
    id: 'threatintel-vulns', view: 'threat-intel', target: 'threatintel-vulns', placement: 'left',
  ...
  // ── REPORTS ─────────────────────────────────────────────────────────────
  {
    id: 'go-reports', view: 'threat-intel', target: 'nav-reports', placement: 'right',
    title: 'Monthly reports',
    body: 'Click "Reports" in the sidebar to see branded deliverables.',
    advance: 'click',
  },
  {
    id: 'reports-table', view: 'reports', target: 'reports-table', placement: 'top',
  ...
  {
    id: 'click-posture-tab', view: 'reports', target: 'reports-posture-tab', placement: 'bottom',
    title: 'Live security posture',
    body: 'Click "Security Posture" to see the live Microsoft Secure Score breakdown.',
    advance: 'click',
  },
  {
    id: 'secure-score', view: 'reports', target: 'secure-score', placement: 'right',
